...
class K_Arr{
	...
	public static function forKey($str)
	{
		
		return $str = mb_convert_encoding(trim($str), "EUC-JP", "auto");
	...
	*/
	...
	public static function arraySquare($array, $fring = 0)
	{
     ...
     /**
	 * @param   array  функци€ определ€ет €вл€ютьс€ ли значени€ массива  неразрывным диапозоном и возвращ€ет боль
	 * @return  false если не диапозон или  array(
         
                      "min" =>1, начальный элемент
                      "max" =>10 конечный элемент
	 ...
	 */
   	...
   	public static function isDiapozon($array)
	{
