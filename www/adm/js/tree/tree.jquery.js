  ...
  Node = (function() {
    ...
    */
    ...
    Node.prototype.moveNode = function(moved_node, target_node, position) {
        //костыль !!
     if (confirm('Вы подтверждаете перемещение?')){	     
  ...
  JqueryWidget = (function(_super) {
    ...
    JqueryWidget.prototype._createDomElements = function(tree, $element) {
      ...
      createNodeLi = function(node) {
       var diasble;
     //  if(!node.available){
      //  diasble='ui-state-disabled';
    //   }
        return $("<li><div class=\""+diasble+"\" ><span class=\"title\">" + node.name + "</span></div></li>");
       };
    ...
    JqueryWidget.prototype._moveItem = function() {
      ...
      //костыль
      var isMove=true;
      isMove=this.tree.moveNode(moved_node, target_node, position);
