var clickedTab = getCookie('latab');
...
*/
	...
	$.fn.simpleTabs = function(){ 
		...
		$("ul.tabs li").click(function() {
			...
			var tabItem = $('.activeTab:first');
			var tabItemIndex = $('ul.tabs li').index(tabItem);
            
			setCookie('latab', tabItemIndex);
			clickedTab = tabItemIndex;
          	return false;
		});
