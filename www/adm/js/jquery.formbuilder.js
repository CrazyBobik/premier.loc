...
(function ($) {
	$.fn.formbuilder = function (options) {
		...
		return this.each(function () {
			...
			var appendNewField = function (type, values, vlds, options, isnew) {
                    ...
                    case 'submit':
						...
						if(typeof (isnew) !== 'undefined' & isnew==true){
							...
							values={'label':'Сохранить','id':'save-button','class':'b-button greyishBtn submitForm'};
