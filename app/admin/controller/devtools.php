...
class Admin_Controller_DevTools extends Controller {
  ...
  public function saveModelAction(){
        ...
        $modelText.= "\r"."\r"."class Admin_Model_".ucfirst($name)." extends Model{"."\n";
  ...
  public function saveControllerAction(){
        ...
        $controllerText.= "\r"."\r"."class Admin_Model_".ucfirst($name)." extends Model{"."\n";
