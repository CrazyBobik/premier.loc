...
class thumbnail
{
  ...
  public $img;
  public $quality = 90;
  public $pos_x = "RIGHT"; // Позиція лого
  public $pos_y = "BOTTOM"; // Позиція лого
  public $imagesPath = ""; // Путь к папке с картинками
  public $logoPath = ""; // Путь к лого
  ...
  function thumbnail($imgfile )
  {
		 ...
		 $imgfile = $this->imagesPath . $imgfile; 
